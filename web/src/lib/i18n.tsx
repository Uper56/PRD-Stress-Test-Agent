...
const zh = {
  ...
  'lc.title': 'Skill 生命周期中心',
  'lc.tab.overview': '总览',
  'lc.tab.proposals': '提案',
  'lc.tab.library': '库',
  'lc.overview.empty': '暂无生命周期数据',
  'lc.count.active': '在役',
  'lc.count.degraded': '已降级',
  'lc.count.deprecated': '已停用',
  'lc.count.total': '总数',
  'lc.degraded.heading': '降级中的 Skill',
  'lc.degraded.none': '当前没有降级 Skill',
  'lc.degraded.since': '降级于 {t}',
  'lc.queue.heading': '干预队列 · 试用期信号',
  'lc.queue.none': '队列空闲',
  'lc.queue.probation': '试用期 {t}/5 次触发 · 反馈 {n} 条',
  'lc.queue.rate': '近期采纳率 {r}',
  'lc.queue.noRate': '暂无反馈',
  'lc.recent.heading': '最近的准入与状态变更',
  'lc.recent.none': '暂无记录',
  'lc.row.status': '状态',
  'lc.row.skill': 'Skill',
  'lc.row.version': '版本',
  ...
  'lc.row.applied': '被引用',
  'lc.row.feedback': '反馈',
  'lc.row.acceptance': '采纳率',
  'lc.row.source': '来源',
  'lc.row.actions': '操作',
  'lc.source.seed': 'seed',
  'lc.source.learned': '提炼 · {n} 份 PRD',
  'lc.source.legacy': '(旧数据导入)',
  'lc.actions.rollback': '↩ 回滚',
  'lc.actions.deprecate': '🗑 停用',
  'lc.actions.lineage': '谱系',
  'lc.actions.md': '📄 MD',
  'lc.library.empty': '库为空',
  'lc.lineage.versions': '版本快照',
  'lc.lineage.transitions': '状态变更审计',
  'lc.lineage.admission': '准入：{d} · {a}',
  'lc.lineage.noAdmission': '准入记录缺失（旧数据）',
  'lc.lineage.evidence': '跨 {n} 份 PRD · 提案 {p}',
  'lc.md.close': '关闭',
  'lc.gates.heading': '准入门禁',
  'lc.gates.run': '▶ 运行门禁',
  'lc.gates.runShadow': '▶ 含影子评估（较慢）',
  'lc.gates.running': '运行中…',
  'lc.gates.spec': '规范',
  'lc.gates.evidence': '证据',
  'lc.gates.novelty': '新颖性',
  'lc.gates.shadow': '影子评估',
  'lc.gates.pending': '未运行',
  'lc.gates.needAll': '四道门禁全部通过后才能采纳',
  'lc.gates.reason': '判定依据',
  'lc.gates.shadowOff': 'OFF',
  'lc.gates.shadowOn': 'ON',
  'lc.gates.hits': '目标模式命中 {n} 份 PRD',
...
const en: Record<keyof typeof zh, string> = {
  ...
  // skill lifecycle center
  'lc.title': 'Skill Lifecycle Center',
  'lc.tab.overview': 'Overview',
  'lc.tab.proposals': 'Proposals',
  'lc.tab.library': 'Library',
  'lc.overview.empty': 'No lifecycle data yet',
  'lc.count.active': 'Active',
  'lc.count.degraded': 'Degraded',
  'lc.count.deprecated': 'Deprecated',
  'lc.count.total': 'Total',
  'lc.degraded.heading': 'Degraded skills',
  'lc.degraded.none': 'No degraded skills right now',
  'lc.degraded.since': 'degraded at {t}',
  'lc.queue.heading': 'Intervention queue · probation signals',
  'lc.queue.none': 'Queue is clear',
  'lc.queue.probation': 'probation {t}/5 triggers · {n} feedback samples',
  'lc.queue.rate': 'recent acceptance {r}',
  'lc.queue.noRate': 'no feedback yet',
  'lc.recent.heading': 'Recent admissions & transitions',
  'lc.recent.none': 'Nothing recorded yet',
  'lc.row.status': 'Status',
  'lc.row.skill': 'Skill',
  'lc.row.version': 'Ver',
  'lc.row.usage': 'Used',
  'lc.row.applied': 'Cited',
  'lc.row.feedback': 'Feedback',
  'lc.row.acceptance': 'Acceptance',
  'lc.row.source': 'Source',
  'lc.row.actions': 'Actions',
  'lc.source.seed': 'seed',
  'lc.source.learned': 'distilled · {n} PRDs',
  'lc.source.legacy': '(legacy import)',
  'lc.actions.rollback': '↩ Rollback',
  'lc.actions.deprecate': '🗑 Deprecate',
  'lc.actions.lineage': 'Lineage',
  'lc.actions.md': '📄 MD',
  'lc.library.empty': 'Library is empty',
  'lc.lineage.versions': 'Version snapshots',
  'lc.lineage.transitions': 'Status audit trail',
  'lc.lineage.admission': 'Admitted: {d} · {a}',
  'lc.lineage.noAdmission': 'No admission record (legacy)',
  'lc.lineage.evidence': '{n} distinct PRDs · proposal {p}',
  'lc.md.close': 'Close',
  'lc.gates.heading': 'Admission gates',
  'lc.gates.run': '▶ Run gates',
  'lc.gates.runShadow': '▶ With shadow eval (slower)',
  'lc.gates.running': 'Running…',
  'lc.gates.spec': 'Spec',
  'lc.gates.evidence': 'Evidence',
  'lc.gates.novelty': 'Novelty',
  'lc.gates.shadow': 'Shadow',
  'lc.gates.pending': 'not run',
  'lc.gates.needAll': 'All four gates must pass before approval',
  'lc.gates.reason': 'Why',
  'lc.gates.shadowOff': 'OFF',
  'lc.gates.shadowOn': 'ON',
  'lc.gates.hits': 'target pattern hit {n} PRDs',

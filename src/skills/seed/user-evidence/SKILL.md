---
name: user-evidence
description: Use this skill WHENEVER the PRD makes a user-pain claim ("users want…", "users struggle with…", "customers complain…", "there is friction in…"). The PRD MUST cite at least one concrete evidence source — analytics, support tickets, interviews, surveys — naming the source. Asserted pain without evidence is founder-fiction and must be flagged P0. Apply this skill aggressively to every user-need statement.
version: "1.0"
created_by: seed
injected_into:
  - user_advocate
trigger_keywords:
  ...
  - feedback
  - interviews
trigger_semantic: PRD asserts a user pain, need, or frustration without citing a concrete data source (tickets, interviews, analytics, survey).
confidence: 0.87
---

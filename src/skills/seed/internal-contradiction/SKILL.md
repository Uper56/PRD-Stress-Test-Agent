...
description: Use this skill ON EVERY PRD review, regardless of role. PRDs are written incrementally and routinely contradict themselves across sections — scope, timeline, metrics, SLA, ownership, constraints. Do an explicit cross-section consistency pass and surface every contradiction as a critique with both line citations. Apply universally — this is a cross-cutting skill all four critics run.
version: "1.0"
created_by: seed
injected_into:
  - engineering
...
trigger_keywords:
  ...
  - but
  - except
trigger_semantic: PRD contains multiple sections whose requirements, scope, or constraints may contradict one another.
confidence: 0.8
---
